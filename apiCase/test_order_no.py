...
class Test_OrderNo:
    ...
    def test_saveAddressBook(self, class_fixture_login):
    ...
    def test_queryAvailableProduct(self, class_fixture_login):
        ...
        assert "成功" == response["msg"]
        maxLoanAmount = response['data'][0]['maxLoanAmount']
        loanDay = response['data'][0]['loanDay']
        productNo = response['data'][0]['productNo']
        return maxLoanAmount, loanDay, productNo

    def test_saveDeviceInfo(self, class_fixture_login):
    ...
    def test_submitOneProduct(self, class_fixture_login):
        parms = self.test_queryAvailableProduct(class_fixture_login)
