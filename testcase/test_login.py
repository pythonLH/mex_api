...
class Test_login:
    ...
    def test_01(self):
        ...
        body = json.dumps({"adbEnabled": 0,
                           ...
                           "uuidOriginal": "[-70, -118, 63, -4, -105, 63, -86, -22, 0, 9, -17, -118, -81, 47, 85, -2, "
                                           "75, 39, "
                                           "17, 82, -88, -99, -109, -86, 54, 97, 106, -31, -37, -49, 74, -32]"})
        try:
            resp = Request('post', url_=url, body_=body, cookies=None, headers_=self.header).get_json()
            print(resp)
    ...
    def test_02(self, ):
        ...
        try:
            resp = Request('post', url_=url, body_=json.dumps(body), cookies=None, headers_=self.header).get_json()
            print(resp)
